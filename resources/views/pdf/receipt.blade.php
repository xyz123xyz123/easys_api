<style>
	...
	<div class="container">
		...
		<div>
            ...
            <table class="bottom">
                <tr>
                    <td colspan="4" style="text-align:right;" class="bold">For {{$society_name}}</td>
                </tr>
                <tr>
                    <td colspan="4" style="text-align:right;padding-top:50px;" class="bold">CHAIRMAN/SCRETRY/ TREASURER</td>
                </tr>            
                <tr>
