...
<div class="container">
    <div>
        <table class="header">
            <tr>
                <td colspan="5" class="societyName">{{$society_data['name']}}</td>
            </tr>
            <tr>
                <td colspan="5">Registetration No : {{$society_data['registeration_no']}}</td>
            </tr>
            <tr>
                <td colspan="5">{{$society_data['address']}}</td>
            </tr>
            <tr>
                <td colspan="5">Email Id - {{$society_data['email_id']}}  Tel. No - {{$society_data['telephone_no']}} </td>
            </tr> 
            <tr>
                <td></td>
                <td></td>
            ...
            <tr>
                <td colspan="5" class="bold">Bill</td>
            </tr>            
        </table>
    </div>
    <hr>
    ...
    <div class="tarrif_data">
        <table class="tarrif">
            ...
            <tr>
                ...
                <td colspan="2" style="width:40%" class="bold">&nbsp; Total</td>
            ...
            <tr>
                ...
                <td class="text-right" style="width: 23%;"  >{{ $bill_data['principal_arrears'] }} </td>  
            ...
            <tr>
                <td colspan="5">{{$society_paramter['bill_note']}}</td>
            </tr>
        </table>
        <table class="bottom">
            <tr>
                <td colspan="8" style="float:right;" class="bold">For {{$society_data['name']}}</td>
            </tr>
            <tr>
